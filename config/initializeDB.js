...
var initDB = [
  ...
  'CREATE TABLE organization_texts (id INT NOT NULL AUTO_INCREMENT, organization VARCHAR(70) NOT NULL, message TEXT, dated DATETIME, PRIMARY KEY (id))',
  'CREATE TABLE follower_texts (id INT NOT NULL AUTO_INCREMENT, follower VARCHAR(70) NOT NULL, to_organization VARCHAR(70) NOT NULL, message TEXT, dated DATETIME, PRIMARY KEY (id))'
];
