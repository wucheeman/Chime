...
var model = {
  ...
  getAllTextsByOrg: function(organization, cb) {
    orm.findWhere('organization_texts', ['message', 'createdAt'], 'organization', organization, function(res) {
      cb(res);
    }); 
  },
  ...
  getSubscriptionMessages: function(follower, cb) {
    orm.leftJoinSelect(['follower', 'organizations_followed.organization', 'message', 'createdAt'], 'organization_texts', 'organizations_followed',  'organization_texts.organization = organizations_followed.organization', `follower = "${follower}"`, function(res) {
      cb(res);
    });
  },
